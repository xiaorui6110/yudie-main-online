package com.yudie.yudiemainbackend.manager.auth;
...
import static com.yudie.yudiemainbackend.constant.CrawlerConstant.BAN_ROLE;
import static com.yudie.yudiemainbackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (BAN_ROLE.equals(loginUser.getUserRole())) {
            throw new BusinessException(ErrorCode.NOT_AUTH_ERROR, "封禁用户禁止访问,请联系管理员");
        }
        // 管理员权限，表示权限校验通过
