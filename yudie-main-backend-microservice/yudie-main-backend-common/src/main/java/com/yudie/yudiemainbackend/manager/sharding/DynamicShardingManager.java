package com.yudie.yudiemainbackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // yudie_picture.picture_112321321,yudie_picture.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                // 确保前缀合法
                .map(tableName -> "yudie_picture." + tableName)
