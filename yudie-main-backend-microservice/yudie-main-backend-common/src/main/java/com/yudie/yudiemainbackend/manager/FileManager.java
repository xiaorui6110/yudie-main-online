package com.yudie.yudiemainbackend.manager;
...
import com.yudie.yudiemainbackend.config.CosClientConfig;
...
public class FileManager {
    ...
    public UploadPictureResult uploadPicture(MultipartFile multipartFile, String uploadPathPrefix) {
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.INTERNAL_SERVER_ERROR, "上传失败");
        } finally {
            // 临时文件清理
